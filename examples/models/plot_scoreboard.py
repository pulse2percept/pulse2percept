...
The scoreboard model assumes that electrical stimulation leads to the percept
...
.. important::
    ...
    As pointed out by [Beyeler2019]_, the scoreboard model cannot explain
    percepts generated by **epiretinal** implants, where incidental stimulation
    of retinal nerve fiber bundles leads to elongated, 'streaky' percepts.
